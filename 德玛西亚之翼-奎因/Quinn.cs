...
namespace YuleQuinn
{
    class Quinn
    {
        ...
        public void LoadQuinn()
        {
            ...
            Config.SubMenu("Q Config").AddItem(new MenuItem("harrasQ", "Harass Q", true).SetValue(true));
            Config.SubMenu("Q Config").AddItem(new MenuItem("farmQ", "LaneClear Q", true).SetValue(true));
            Config.SubMenu("Q Config").AddItem(new MenuItem("LCminions", "LaneClear minimum minions", true).SetValue(new Slider(2, 10, 0)));
            Config.SubMenu("Q Config").AddItem(new MenuItem("jungleQ", "Jungle clear Q", true).SetValue(true));

            Config.SubMenu("E Config").AddItem(new MenuItem("harrasE", "Harass E", true).SetValue(true));
            Config.SubMenu("E Config").AddItem(new MenuItem("jungleE", "Jungle clear E", true).SetValue(true));
            Config.SubMenu("E Config").AddItem(new MenuItem("AGC", "AntiGapcloser E", true).SetValue(true));
            Config.SubMenu("E Config").AddItem(new MenuItem("Int", "Interrupter E", true).SetValue(true));


            Config.SubMenu("Auto").AddItem(new MenuItem("autoQ", "Auto Q", true).SetValue(true));
            Config.SubMenu("Auto").AddItem(new MenuItem("autoW", "Auto W", true).SetValue(true));
            Config.SubMenu("Auto").AddItem(new MenuItem("autoE", "Auto E", true).SetValue(true));
            Config.SubMenu("Auto").AddItem(new MenuItem("autoR", "Auto R in shop", true).SetValue(true));

            Config.SubMenu("Misc").AddItem(new MenuItem("Mana", "LaneClear Mana", true).SetValue(new Slider(80, 100, 0)));
            Config.SubMenu("Misc").AddItem(new MenuItem("farmP", "攻击标记的小兵", true).SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("focusP", "攻击标记的敌人", true).SetValue(true));

            foreach (var enemy in ObjectManager.Get<Obj_AI_Hero>().Where(enemy => enemy.IsEnemy))
                Config.SubMenu("英雄列表").SubMenu("骚扰列表 ->").AddItem(new MenuItem("harras" + enemy.ChampionName, enemy.ChampionName).SetValue(true));
            foreach (var enemy in ObjectManager.Get<Obj_AI_Hero>().Where(enemy => enemy.Team != Player.Team))
                Config.SubMenu("英雄列表").SubMenu("反突列表 ->").AddItem(new MenuItem("gap" + enemy.ChampionName, enemy.ChampionName, true).SetValue(true));
