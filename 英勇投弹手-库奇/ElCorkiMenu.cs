namespace ElCorki
{
    ...
    public class ElCorkiMenu
    {
        ...
        public static void Initialize()
        {
            ...
            var credits = new Menu("Credits", "娛樂作品");
            credits.AddItem(new MenuItem("ElCorki.Paypal", "娛樂VIP腳本群：215226086"));
            credits.AddItem(new MenuItem("ElCorki.Email", "欢迎你的加入"));
            _menu.AddSubMenu(credits);

            _menu.AddItem(new MenuItem("422442fsaafs4242f", ""));

            _menu.AddItem(new MenuItem("422442fsaafsf", (string.Format("ElCorki by jQuery v{0}", ScriptVersion))));
            _menu.AddItem(new MenuItem("fsasfafsfsafsa", "Made By yule"));
